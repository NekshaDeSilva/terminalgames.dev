    ...
    for(ll x =0;  x <  numofvals; x ++){
        ...
        if(left == x ){
            ...
            othertwo.second =list[right].second;
               ...
               othertwofound  = true;
            //    break; if we place this break here., then anything happening afterwards wont be done, which mean that everything happening afterwards will be seized. #include <iostream>
#include <iomanip>
#include <cmath>
#include <climits>
#include <vector>
